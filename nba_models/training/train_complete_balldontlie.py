...
def process_games_for_training(games: list[dict], player_stats_by_game: dict[int, list[dict]]) -> tuple[list[dict], list[dict]]:
    ...
    for i, game in enumerate(games_sorted):
        ...
        team_features = {
            ...
            'home_timezone_change': abs(home_travel_features['timezone_crossings']),
            'away_timezone_change': abs(away_travel_features['timezone_crossings']),
            'timezone_advantage': abs(away_travel_features['timezone_crossings']) - abs(home_travel_features['timezone_crossings']),
            'home_altitude_disadvantage': home_travel_features['altitude_adjustment'],
            'away_altitude_disadvantage': away_travel_features['altitude_adjustment'],
            'home_travel_fatigue': home_travel_features['fatigue_score'],
            'away_travel_fatigue': away_travel_features['fatigue_score'],
            'fatigue_advantage': away_travel_features['fatigue_score'] - home_travel_features['fatigue_score'],
            'away_coast_to_coast': away_travel_features['is_coast_to_coast'],
